...
vezes (prosa, eixos, `exige` e `peso` idênticos byte a byte; só
...
empata), é `exige`: cada uma exige um tipo de evidência distinto.

| Variante | Objeção | Exige (tipo de prova) | Momento |
|---|---|---|---|
...
| [[reviews-7-zigue-zague-com-cupom]] | qualidade-eficácia | selo de compra verificada + cupom ativo + reviews curtos | consideração |
