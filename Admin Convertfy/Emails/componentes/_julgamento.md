...
- Segunda objeção no toque de uma só — o 1 e o 3 atacam uma, bem; varredura é só do 2 (`n_objecoes` em [[welcome-1]], [[welcome-3]]).
...
- **Comercial.** Tem cupom ativo e válido para publicar? ([[cupom-ativo]] — 9 variantes dependem dele: hero-3/4/5/6, offer-3/4/5/6, reviews-7.) O desconto é automático, sem código? ([[desconto-automatico-sem-cupom]] — não convive com cupom.) A oferta tem data real de expiração? ([[prazo-real]].) É percentual puro, exibível como número? ([[desconto-percentual]].)
...
**Escolha a de cima e diga qual perdeu** — nunca resolver em silêncio. Duas fontes discordando é informação: as duas aparecem nomeadas na decisão.
