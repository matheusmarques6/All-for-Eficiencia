...
papel_na_peca: [meio]
itens: { min: 3, max: 3 }
peso: { altura_px: 1288, classe: pesado, fonte: medido }
...
## Quando não usar
Quando há exatamente 4 produtos para mostrar: a vitrine tem 3 linhas — com 4 produtos, usar a grade 12/15. E as exclusões de qualquer vitrine: [[welcome-4]] (proíbe catálogo) e primeiros toques de carrinho.
