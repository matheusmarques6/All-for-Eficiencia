...
paleta: [claro]
papel_na_peca: [meio]
peso: { altura_px: 452, classe: leve, fonte: medido }
convivencia: []
...
## Notas de cadastro
Descrição do banco bate com a anatomia. O 452px do cadastro é a altura do quadro; sem o HTML da variante não dá para confirmar padding externo — medida registrada como está no banco. `duas-fotos-comparaveis` não existe em `requisitos/`; listado no relatório.
