...
## Notas de cadastro
A homônima da seção offer (f8fd38f6-04d0-4337-a130-31e207510b59) foi renomeada para "offer 21" em 19/09 — o nome "body 21" voltou a ser único. Descrição do banco bate com a anatomia. Relação com a lacuna [[body-garantias-3-selos]]: mesma família de dispositivo, mas a lacuna pede faixa compacta de APOIO e esta é bloco de meio com headline, corpo e foto — não a fecha; registrado no relatório. `peso` medido no HTML de produção em 19/09.
