...
tipo: indice
modulo: campanhas
assunto: conflitos-campanhas-formato-e-pilares
autor: max-sturtevant
conflitos: [campanhas-ratio-grafico-texto, campanhas-frequencia-de-texto-puro, campanhas-distribuicao-dos-pilares]
status: aprovado
---

Registro dos conflitos do módulo `campanhas` do corpus de Max Sturtevant sobre o formato e o conteúdo do que se envia: o ratio entre email gráfico e texto, a frequência de texto puro e a distribuição dos pilares de conteúdo. Cada entrada lista os valores divergentes por registro e fecha com um "Como responder".
