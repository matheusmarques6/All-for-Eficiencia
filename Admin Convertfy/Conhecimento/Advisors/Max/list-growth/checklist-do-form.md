...
"Oh my gosh, this is so much work. I'm not going to opt in" (L1001). Pedir email,
e só no passo seguinte o SMS (L655) — ver [[copy-do-form]].

**Time delay.** Ele proíbe valores fora da faixa: "Don't use any other time
delay. I just recommend doing 4 seconds, 12 seconds, 8 seconds, 10 seconds. One
of those" (L655). O racional dos dois lados: disparar imediato é ruim porque "the
customer hasn't even seen your products" (L1033); esperar 30 ou 40 segundos é
ruim porque pouca gente fica tanto tempo na página (L1034). **Três faixas
diferentes no corpus — ver abaixo.**
...
experience" (L657). A contramedida é comprimir a imagem — ver
[[criar-form-no-klaviyo-desktop]] (L856).
...
(L659). Na versão do YouTube é mais duro ainda: "cut as much copy as possible",
porque "Every little piece that we add is going to increase the odds that
somebody churns off of this form" (L1036-1037).

**A oferta é o maior elemento visual.** "15% off, big in your face, 10% off right
in your face... It's the biggest part, that's all people care about" (L661).
...
X" (L750); escondendo o X ela é forçada a decidir (L752, L1046-1047). O botão de
recusa é obrigatório — "we're going to get a lot more opt-ins if we don't give
people an option. But that's going to be bad for website conversion rates. We
need to give people an option" (L1047). Copy em [[copy-do-form]].
