...
Tabela nota a nota da aplicação do laudo [[mapa-da-autoria]] à pasta `doutrina/` (8 de 13 notas + 1 aviso anulado + índice) e às 2 notas de `flows/` alcançadas fora das cinco pastas do escopo, mais o banner posto na entrada de conflito `doutrina-narrador-da-aula-de-ia`. É a pasta onde os nove avisos escritos antes do laudo foram reescritos, porque todos argumentavam pela assinatura de abertura. O método está em [[mapa-da-aplicacao-de-autoria]].
...
# Entrada de conflito de doutrina — hoje em [[conflitos-de-doutrina]]

Entrada `doutrina-narrador-da-aula-de-ia` recebeu banner **SUPERADO EM PARTE POR
[[mapa-da-autoria]]**: a conclusão de dois narradores fica, a tabela de assinaturas fica
como registro do que foi tentado, **não como evidência**.

---

Ver também [[aplicacao-autoria-em-deliverability-e-otimizacao]] e
[[aplicacao-autoria-em-campanhas-e-copy]]. A ressalva sobre `flows/sunset`, que o
laudo não lista, está em [[ressalvas-e-limites-da-aplicacao-de-autoria]].
