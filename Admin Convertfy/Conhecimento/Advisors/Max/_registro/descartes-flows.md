...
|---|---|---|
| L3417-3424 | Bio do Max + quatro links de rede social | Não é doutrina. O `$100M` de L3419 foi para [[numeros-de-claims-institucionais]] como credencial disputada, não como fato. |
| L3426-3429 | "Sign Up For Klaviyo For Email Marketing" — link de afiliado com "free to start and takes 2 minutes to setup" | CTA comercial. O `$200M` de L3428 está registrado em [[numeros-de-claims-institucionais]] e em [[conflitos-de-doutrina#doutrina-receita-da-agencia]] justamente porque a origem é promocional. |
...
| L4178-4185 | "That's It For This One!", "Want More Help?", consultoria para marcas de $50k/mo | Fechamento comercial. O piso de $50k/mo entrou em [[numeros-de-claims-institucionais]] por ser número declarado, mas não sustenta nenhuma nota. |
...
| L2911 | "Still 1x% off" | provavelmente *10% off* | valor de desconto — mantido verbatim em [[numeros-de-flows-abandono#Cart / checkout abandon]] com marca de corrupção |
...
|---|---|---|
| L1318-1368, L3469-3484 | O argumento de CAC do pop-up | `list-growth/` — usado em [[welcome-flow]] só como racional do flow |
| L3435-3444 | Definição geral de "o que são flows" e a divisão 50/50 flow vs campanha | `doutrina/` — o número está em [[numeros-de-fundamentos-metas-e-glossario#Tabela de metas e glossário]] (registrado em L326) |
...
- **A hesitação "days 30 through 60-ish, 21 through 60-ish"** (L3233-3235). Não
  ...
  [[replenishment]] e em [[conflitos-de-flows-pos-compra-e-winback#replenishment-janela]].
