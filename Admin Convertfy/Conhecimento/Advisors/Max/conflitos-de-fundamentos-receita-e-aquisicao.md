...
tipo: indice
modulo: fundamentos
assunto: conflitos-fundamentos-receita-e-aquisicao
autor: max-sturtevant
conflitos: [fundamentos-roi-do-email, fundamentos-split-campanhas-flows, fundamentos-denominador-dos-80, fundamentos-limiar-de-escalar-aquisicao, fundamentos-piso-de-email-share, fundamentos-anuncios-por-dia, fundamentos-formula-da-lucratividade]
status: aprovado
---

Registro dos conflitos do módulo `fundamentos` do corpus de Max Sturtevant sobre os números de receita e de aquisição do email: ROI do email, split entre campanhas e flows, o denominador dos 80%, o limiar para escalar aquisição, o piso de email share, anúncios por dia e a fórmula da lucratividade. Cada entrada lista os valores divergentes por registro e fecha com um "Como responder".
