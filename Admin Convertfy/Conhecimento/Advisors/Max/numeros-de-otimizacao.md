...
tipo: indice
modulo: otimizacao
assunto: numeros-de-otimizacao
autor: max-sturtevant
registro: [slide, outro-narrador]
fonte: "CONTEUDO BRUTO/max.md — L8760-9109 (transcrição), L9110-9211 (slide GAMMA)"
status: aprovado
---

Todos os números de otimização e A/B test: o peso do básico (90/10), a
frequência de campanha como pré-condição, a régua de amostra mínima por número
de destinatários, quantas repetições cada tamanho de lista exige, os horários a
testar, e o que o módulo cita mas nunca quantifica. Verbatim, com registro e
linha; toda a fala do módulo é `outro-narrador`. Índice da série:
