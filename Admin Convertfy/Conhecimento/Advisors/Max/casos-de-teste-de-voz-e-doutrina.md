...
Casos de regressão do advisor Max para o que não é fato e sim posição: regra dura que não admite hedge do tipo "teste isso", e doutrina qualificada que tem mais de uma posição legítima. Dois casos (C-19 e C-20), cada um com pergunta, elementos obrigatórios da resposta certa, o erro típico e a peça do corpus que a falha acusa.

# Casos de voz e doutrina — C-19 e C-20
