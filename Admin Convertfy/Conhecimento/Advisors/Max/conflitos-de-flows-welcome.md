...
tipo: indice
modulo: flows
assunto: conflitos-flows-welcome
autor: max-sturtevant
conflitos: [welcome-contagem-de-emails, welcome-cadencia, welcome-estrutura-da-sequencia, welcome-contagem-de-fillers, welcome-catalogo-de-fillers, welcome-prazo-da-oferta, welcome-valor-do-desconto]
status: aprovado
---

Registro dos conflitos do módulo `flows` do corpus de Max Sturtevant sobre o welcome flow: quantos emails, cadência, estrutura da sequência, contagem e catálogo de fillers, prazo da oferta e valor do desconto. Cada entrada lista os valores divergentes por registro e fecha com um "Como responder".
