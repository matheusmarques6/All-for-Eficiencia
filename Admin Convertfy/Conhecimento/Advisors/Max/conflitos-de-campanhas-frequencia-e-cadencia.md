...
tipo: indice
modulo: campanhas
assunto: conflitos-campanhas-frequencia-e-cadencia
autor: max-sturtevant
conflitos: [campanhas-sweet-spot-de-frequencia, campanhas-tier-250k-1m, campanhas-o-que-determina-a-frequencia, campanhas-cadencia-alta-vs-tier-1m]
status: aprovado
---

Registro dos conflitos do módulo `campanhas` do corpus de Max Sturtevant sobre com que frequência enviar: o sweet spot de frequência, o tier de 250k a 1m, o que determina a frequência e a cadência alta contra o tier de 1m. Cada entrada lista os valores divergentes por registro e fecha com um "Como responder".
