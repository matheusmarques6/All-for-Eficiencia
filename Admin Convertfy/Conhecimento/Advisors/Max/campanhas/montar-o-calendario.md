...
> customizado. Qualquer um pode ter mudado ou saído do ar. As telas descritas
> são as do momento da gravação.
...
**1. Espionar concorrente.** [milled.com](https://milled.com/),
...
**4. IA.** "Use AI strategically to build your calendar" (L5354); no slide do
módulo, "**(Use AI!!!)**" (L4437). A ferramenta é o **Email Marketing Brain**,
...
> list out a hundred potential campaign ideas. Doesn't have to be date
> specific, but want it to be super creative, highly applicable, highlight any
> applicable hot holidays (…) very out of the box engaging content for our
> email list (L4594-4600)

# Duas táticas específicas

**Feriados obscuros** (L4606-4620). "find the most random holidays. As long as
...
sort of last chance campaign as well." No exemplo do calendário Nike, é a
...
Não há ordem de prioridade entre os 4 passos, nem quantas ideias tirar de cada
fonte. Não há regra de espaçamento entre anúncio, lembrete e last chance. Os
placeholders "Step 1 / Step 2 / Step 3 / Results" do slide (L5480-5486) são
legendas de imagem sem imagem no bruto.

# Ligações

[[os-cinco-pilares-de-conteudo]] · [[cem-ideias-de-email]] · [[segmentacao-de-campanhas]]
