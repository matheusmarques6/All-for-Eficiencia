...
A posição dele contraria o consenso e vem primeiro porque muda o que se
otimiza:

> "**IMPORTANT: Your Subject Line and Preview Text Shouldn't Matter for Getting
> Opens**" (L6800)
...
Daí a instrução de medição, que é o que realmente distingue a posição dele:
...
**Teste 1** (L6129-6133): a variação vencedora gerou 2.3k no período e teve
open rate **menor**; click rate muito maior; "3x the placed order rate" e
"almost 4x the amount of revenue in this period".

**Teste 2** (L6133-6135): open rates "nearly identical"; click rate muito maior
em B; "nearly 4x the amount of orders", "just under double the recipient and a
...
Todos esses números, com suas variações entre registros, estão em [[numeros-de-email-marketing-mais-pedidos]].
...
Nunca traduzir. Os quatro cumprem a regra de 2-5 palavras e Title Case, e
nenhum termina em reticências — terminam em emoji.
...
- **Slide, módulo de otimização (L9206-9207)** — é o teste **Personalization
  ...
  [[otimizacao/outros-testes-de-ab]].
