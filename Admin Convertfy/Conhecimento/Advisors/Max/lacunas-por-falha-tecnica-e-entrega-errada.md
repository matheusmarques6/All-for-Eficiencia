...
Registro das lacunas que não são omissão do autor e sim defeito do registro do
corpus Max: o conteúdo que existiu e sumiu por falha de ASR, de export ou de
corte de vídeo (**perda por falha técnica**), e o material que promete uma coisa
e entrega outra (**entregue errado**). Aqui a resposta muda de forma — não se
diz "ele não fala disso", se diz que o registro se perdeu; e no segundo caso não
se recusa, se avisa. Índice em [[mapa-da-cobertura]].
