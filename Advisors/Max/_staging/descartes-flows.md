...
| L2364 | "like a card abandoned" | *cart abandoned* | comparação de intenção em [[site-abandon]] |
...
| L2996-2998 | "With this row collection and row alias. Alias." | repetição de ASR | fórmula do checkout — a versão boa está no slide L3903-3904 |
...
| L2366-2369, L3384-3387 | Frequência de campanha (3-4/semana, 3x/semana) | `campanhas/` — números registrados, conflito aberto |
...
- **A hesitação "days 30 through 60-ish, 21 through 60-ish"** (L3234-3236). Não
...
- **"Trust me. We've tested this."** (L2904-2906). É a única justificativa que
  ele dá para dois text-based em quatro emails. Mantida com a fraqueza à vista.
- **"This is what we've always done"** (L2990-2992). Admissão de que a diferença
