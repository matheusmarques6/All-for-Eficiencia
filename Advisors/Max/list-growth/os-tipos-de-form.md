...
"Hey, take x% discount on your order. Give us your email address" (L998, L639).
Fácil de executar e às vezes vence, mas "I don't see it work better too often
compared to the other form styles" (L998). O veredito é temporal: "This is more
of a pop-up form from the past" (L999). Dois contras declarados: as pessoas
desengajam em taxa alta por já estarem saturadas dele, e você não extrai nenhum
dado do cliente (L999).
...
L784). Ele estende o mesmo efeito ao passo de SMS (L1006).

Taxa de vitória declarada: "I'd say 75% of the AB tests that I do, this one
beats out the classic. I would probably say even a little bit more towards like
80 to 85%" (L1007). O limite: continua sem coletar dado do cliente (L1007).
...
have customtailored solutions for them" (L1010). Na fala do curso: "it feels
customized to the customer um and it makes them feel like they earn their
discount" (L645).

Bônus estrutural: a resposta vira profile property e permite customizar os emails
seguintes (L1012). Ver [[segmentacao-vinda-do-form]].

## Spin-to-Win

"You spin a wheel and the customer gets a discount" (L1015). "These actually work
really, really well, usually better than just like the classic" (L1016). A
ressalva é de marca, não de performance: "it can be a little bit tacky, so you
might hurt your brand a little bit, but I've seen it work well" (L1016). Na aula
do curso, só "A little bit more tacky um but that is something you can do"
(L645).
