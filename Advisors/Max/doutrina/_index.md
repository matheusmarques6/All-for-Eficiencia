...
Os princípios que atravessam os módulos. Nenhum deles pertence a um flow, a uma
campanha ou a uma tela de ferramenta — todos reaparecem em vários lugares do
...
|---|---|
| [[o-custo-do-anuncio-e-travado-o-valor-do-clique-nao]] | a tese fundadora: CPM não é variável sua, o valor do clique é |
| [[crescimento-de-lista-vence-tamanho-de-lista]] | reposição precisa superar o churn; entrada é a métrica, não o total |
| [[o-inscrito-novo-e-mais-quente-que-o-atual]] | janela de honeymoon de ~30 dias; por que flow ganha de campanha |

# Atenção do cliente — como o email é lido
...
2. **Não apresentar como consenso de mercado.** Várias destas posições são dele
   ...
   a de que roubar layout é o método, a de que texto puro só funciona enquanto for
   raro. É exatamente onde o corpus tem valor.
